...
This version uses Python requests instead of curl for better compatibility.
Usage: python extract_parliament_stream_v3.py <parliament_tv_event_url>
Example: python extract_parliament_stream_v3.py https://parliamentlive.tv/event/index/263b4186-393c-49ce-aa55-68b9accd7a4e?in=13:25:38
"""
...
def extract_stream_urls_using_requests(event_id, time_marker=None):
    """
    Use requests to fetch the player page and extract stream URLs.
    """
