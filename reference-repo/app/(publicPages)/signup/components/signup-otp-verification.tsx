...
import { Loader2, Shield, Sparkles, CheckCircle2 } from "lucide-react";
...
export function SignupOTPVerification({ 
  form, 
  userEmail, 
  isParliamentMember,
  otpValue,
    ...
    <div className="space-y-6">
      ...
      {isParliamentMember && (
        <div className="bg-muted/50 rounded-lg p-4 border border-primary/20">
          ...
          <p className="text-sm text-muted-foreground">
            MP Setup page to complete your parliamentary profile
          </p>
        </div>
      )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormDescription>
                  Enter the 6-digit code from your email to complete signup
                </FormDescription>
                <FormMessage />
              </FormItem>
            )}
