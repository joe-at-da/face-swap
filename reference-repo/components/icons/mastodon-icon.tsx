...
/**
 * Mastodon icon component matching Lucide icon style
 * Based on the official Mastodon logo, adapted to outlined stroke style
 */
export const Mastodon = React.forwardRef<SVGSVGElement, LucideProps>(
  ({ className, ...props }, ref) => (
    <svg
      ref={ref}
      ...
      {...props}
    >
      {/* Mastodon logo - filled style to match visibility of other icons */}
