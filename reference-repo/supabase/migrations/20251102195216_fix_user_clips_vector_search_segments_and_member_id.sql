-- Fix search_user_clips_by_vector function with all corrections:
-- 1. Use clip_id instead of parliament_clip_id
-- 2. Get timestamp fields from parliament_member_clips (pmc), not user_clips (uc)
-- 3. Correct join: use pm.member_id not pm.id
-- 4. Use party_name/party_abbreviation instead of current_party
-- 5. Include segments field
-- 6. Include member_id
-- 7. Use 0.2 threshold as default (matching parliament clips search)
