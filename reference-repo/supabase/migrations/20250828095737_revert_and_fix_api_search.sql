-- Revert search function back to use parliament_member_clips.transcript for consistency
-- The API layer will handle searching user_clips.transcript where needed
...
'Function to search user clips checking both user_clips.transcript and parliament_member_clips.transcript for comprehensive search coverage.';

-- Log migration completion
DO $$
BEGIN
    RAISE NOTICE 'Reverted search function to search both transcript fields appropriately';
END;
$$;