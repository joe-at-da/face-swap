-- Add session_uid to search_parliament_clips_by_vector return table
-- This enables enriching search results with parliament_events data (session_date and title)

-- Drop existing function
DROP FUNCTION IF EXISTS search_parliament_clips_by_vector(text, integer, integer, float);

-- Recreate with session_uid in return table
