-- Tune hybrid search: raise semantic threshold 0.25→0.35, increase candidate_limit 60→200
-- 0.25 was too low (parliament speeches share language patterns, most clips pass it)
-- candidate_limit 60 is too small for production with 100K+ clips per MP
