-- Add semantic similarity threshold to hybrid search to prevent returning all clips
-- Without this, the semantic CTE grabs every clip with an embedding (no minimum relevance)
