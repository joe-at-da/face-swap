        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="text-white font-medium">1.2 GB / 8 GB</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-gray-400">Disk Usage</span>
                <span className="text-white font-medium">24 GB / 100 GB</span>
              </div>
              <div className="flex justify-between items-center">
          ...
          <div className="bg-white dark:bg-gray-800 shadow rounded-lg p-6 md:col-span-2">
            <div className="flex justify-between items-center mb-4">
              ...
              <div>
                <select className="bg-gray-700 border border-gray-600 text-white text-sm rounded-lg focus:ring-primary focus:border-primary block p-2">
          ...
          <div className="bg-white dark:bg-gray-800 shadow rounded-lg p-6 md:col-span-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                <h3 className="font-medium text-white mb-2">Advanced Monitoring</h3>
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  Integration with Prometheus and Grafana for detailed system metrics and dashboards.
                </p>
              </div>
              <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                <h3 className="font-medium text-white mb-2">Backup Management</h3>
                <p className="text-sm text-gray-500 dark:text-gray-400">
...
export default withAuth(SystemAdminPage, [UserRole.ADMIN]);
