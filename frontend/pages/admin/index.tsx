          ...
          {statsLoading ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-gray-900 rounded-lg p-6">
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-4">
                    <div>
                      <h4 className="text-sm font-medium text-gray-400 mb-2">Video Clips</h4>
                    ...
                    <div>
                      <h4 className="text-sm font-medium text-gray-400 mb-2">Capture Sessions</h4>
                      <div className="grid grid-cols-2 gap-2">
                        <div className="bg-gray-800 p-3 rounded-lg text-center">
                ...
                <div className="bg-gray-900 rounded-lg p-6">
                  ...
                  <div className="grid grid-cols-3 gap-4 mb-4">
                    ...
                    <div className="bg-gray-800 p-4 rounded-lg text-center">
                      <p className="text-2xl font-bold text-purple-400">{systemStats.social.scheduled_posts}</p>
            ...
            <div className="p-6 text-center">
              <div className="flex flex-col items-center justify-center py-12">
                ...
                <p className="text-sm text-gray-400 mt-1">Please try refreshing the page or contact support if the issue persists.</p>
              </div>
              <button 
